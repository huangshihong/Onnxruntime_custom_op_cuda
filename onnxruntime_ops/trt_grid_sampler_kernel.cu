...
__global__ void grid_sampler_2d_kernel(const int nthreads, const scalar_t* input,
    ...
    mmdeploy::TensorDesc_64 input_desc, mmdeploy::TensorDesc_64 grid_desc,
    mmdeploy::TensorDesc_64 output_desc,
...
void create_desc(const int64_t* dims, int nb_dims, mmdeploy::TensorDesc_64& desc) {
